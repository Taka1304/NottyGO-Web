  ...
  return (
    ...
    <Header />
      ...
      <Box sx={{display: 'flex', justifyContent: 'center', my: 3}}>
        {available && uid && !flag ? <Button size='large' variant='contained' sx={{justifyContent: "center"}} onClick={handleSubmit}>スタンプをゲット</Button> : <Button variant='contained' sx={{justifyContent: "center"}} disabled>上記項目を満たしてください</Button>}
      </Box>
